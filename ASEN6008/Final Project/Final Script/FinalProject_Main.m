%{
Final Project -- Construction of VEES trajectory launching in 2025. Construct PCPs using given baseline mission dates and then create
...
Event.LaunchJD = 2460730.5;
Event.VGAJD =  2460910.5;
Event.EGA1JD = 2461226.5;
Event.EGA2JD = 2462322.226567;
Event.SOIJD = 2464117.5;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EGA1/EGA2
%compute EGA2 to SOI params in order to get EGA1 to EGA2 params/ vinfs
EGA2Ephem = Meeus(Event.EGA2JD);
