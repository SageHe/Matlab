...
R = 5*diag([sigma_rho sigma_rhodot sigma_rho sigma_rhodot sigma_rho sigma_rhodot]);
...
%     dt = ti - ti_minus;
    ...
    [a,e,inc,w,W,P,ehat,ehatperp,f] = compOE(x_ti(1:3),x_ti(4:6),mu);
    ric2eci = angle2dcm(-(f+w),-inc,-W,'ZXZ');
    Qsigma = 4e-07*ones(1,3);
    Qsigma = ric2eci*Qsigma';
