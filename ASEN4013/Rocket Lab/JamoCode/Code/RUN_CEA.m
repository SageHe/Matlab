function[SM_results1,SM_results3] = RUN_CEA(Pc_en, AR_sup)
    ...
    SM_inputs.ox1wt    = 80; %OG 80                     %primary oxidizer weight (by mass) in total 
    SM_inputs.ox2wt    = 10; %OG 10                       % secondary oxidizer weight (by mass) in total
    SM_inputs.fu1wt    = 10; %OG 10                       % primary fuel weight (by mass) in total
